...
set curtime=!curtime::=!
set curtime=!curtime:.=!
set curtime=!curtime:~0,6!


rem set cur_hou=%curtime:~0,2%
rem if "%curtime:~0,1%"==" " set cur_hou=0%curtime:~1,1%
rem set cur_min=%curtime:~3,2%

set curdate=%date%
set cur_yea=%curdate:~0,4%
set cur_mon=%curdate:~5,2%
set cur_day=%curdate:~8,2%
set archievename=%pfn%_%cur_yea%%cur_mon%%cur_day%%curtime%_%proj_packager_name%.zip
